...
def extract_features_from_games(games_data, username):
    ...
    for game in games_data['games']:
        ...
        hour_of_game = game_time.hour
        day_of_game = game_time.day

        user_rating = game[user_color]['rating']
        opponent_rating = game[opponent_color]['rating']
        rating_differnce = user_rating - opponent_rating
        ...
        feature = {
            ...
            'rating_differnce': rating_differnce,
            'time_control': time_control,
            'opening': opening_name,
            'hour_of_game': hour_of_game,
